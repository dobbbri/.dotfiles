...
static const struct arg args[] = {
  ...
  { battery_perc,     "^c#fe8019^ 󰄌 ^d^ %s%% ",         "BAT0"},
	{ ram_used,         "^c#fe8019^ 󰍛 ^d^ %s ",           "NULL" },
	{ alsa_master_vol,  "^c#fe8019^ 󰕾 ^d^ %s ",           "NULL" },
  { backlight_perc,   "^c#fe8019^ 󰃟 ^d^ %s ",           "acpi_video0"},
	{ datetime,         "^c#fe8019^  ^d^ %s ", 	        "%H:%M"},
