...
static const char *fonts[]          = { "jetBrainsMono Nerd Font:style=bold:size=13:antialias=true" };
static const char dmenufont[]       = "jetBrainsMono Nerd Font:style=bold:size=13:antialias=true;";
