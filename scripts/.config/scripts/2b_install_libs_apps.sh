...
echo "install libs"
sudo apt install -y xorg xorg-dev dbus-x11 xinput hsetroot dialog gvfs psmisc fuse3 \
  libnotify-bin xdotool unzip xinit xdotool curl unzip ssh-askpass wget stow \ 
  heif-gdk-pixbuf webp-pixbuf-loader \
